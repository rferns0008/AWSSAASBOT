...
locals {
  ...
  # Backend/LB Certificate (Your existing ap-south-1 cert)
  # Replace with the actual ARN from your Mumbai console
  backend_cert_arn = "arn:aws:acm:ap-south-1:078083578991:certificate/e583e1f8-ee5b-485d-ac94-4eac34d1d887"
}
...
# Record for Frontend (CloudFront)
...
# Record for Backend API (Load Balancer)
# NOTE: This assumes your K8s service name is 'chatbot-service'
# data "aws_elb" "eks_lb" {
  # We use a filter because the actual LB name is generated by K8s
  # You might need to run apply twice or use a specific name if known
  # name = "REPLACE_WITH_LB_NAME_AFTER_FIRST_DEPLOY" 
# }
...
# resource "aws_route53_record" "api" {
  ...
  # alias {
    # name                   = data.aws_elb.eks_lb.dns_name
    # zone_id                = data.aws_elb.eks_lb.zone_id
